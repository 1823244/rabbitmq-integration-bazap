...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ПараметрыРегистрации.Вставить("Наименование","Плагин_RabbitMQ_экспорт_Документ_КСП_ПланПродажПоКоллекциям");
	ПараметрыРегистрации.Вставить("БезопасныйРежим", Ложь);
	ПараметрыРегистрации.Вставить("Информация","Плагин_RabbitMQ_экспорт_Документ_КСП_ПланПродажПоКоллекциям");
	...
	ДобавитьКоманду(ПараметрыРегистрации.Команды, 
		"Открыть форму : Плагин_RabbitMQ_экспорт_Документ_КСП_ПланПродажПоКоллекциям",
		"Форма_Плагин_RabbitMQ_экспорт_Документ_КСП_ПланПродажПоКоллекциям",
		ТипКоманды, 
		Ложь) ;
...
Функция ВыгрузитьОбъект(Ссылка) Экспорт
    ...
    Для сч = 0 По обк.План.Количество()-1 Цикл
		...
		СтрокаПлан.Вставить("Клиент", ксп_ЭкспортСлужебный.СоздатьУзелIdentification(стрк.Клиент));
		//ПланПродаж Число
