...
Функция ВыгрузитьОбъект(ДанныеСсылка) Экспорт
	...
	definition.Вставить("ДатаОкончанияДействия", Обк.ДатаОкончанияДействия);
	...
	definition.Вставить("УчетАгентскогоНДС", Обк.УчетАгентскогоНДС);
	...
	definition.Вставить("ЗапрещаетсяПросроченнаяЗадолженность", ксп_ЭкспортСлужебный.СоздатьУзелIdentification(Обк.ЗапрещаетсяПросроченнаяЗадолженность));
	...
	definition.Вставить("Сумма", ксп_ЭкспортСлужебный.СоздатьУзелIdentification(Обк.Сумма));
	...
	definition.Вставить("ГосударственныйКонтракт", ксп_ЭкспортСлужебный.СоздатьУзелIdentification(Обк.ГосударственныйКонтракт));
	definition.Вставить("ПлатежиПо275ФЗ", Обк.ПлатежиПо275ФЗ);
	definition.Вставить("ТипПлатежаФЗ275", ксп_ЭкспортСлужебный.СоздатьУзелIdentification(Обк.ТипПлатежаФЗ275));
	definition.Вставить("ИностранныйИсполнительВУтвержденномПеречнеГОЗ", Обк.ИностранныйИсполнительВУтвержденномПеречнеГОЗ);
	definition.Вставить("ГрафикИсполненияДоговора", ксп_ЭкспортСлужебный.СоздатьУзелIdentification(Обк.ГрафикИсполненияДоговора));
	...
	definition.Вставить("ПорядокОформленияСписанияНедостачТоваровПринятыхНаХранение", Обк.ПорядокОформленияСписанияНедостачТоваровПринятыхНаХранение);
	definition.Вставить("ПорядокОформленияСписанияВПроизводствоТоваровПринятыхНаХранение", Обк.ПорядокОформленияСписанияВПроизводствоТоваровПринятыхНаХранение);
	...
	definition.Вставить("КомиссионерПартнер", ксп_ЭкспортСлужебный.СоздатьУзелIdentification(Обк.КомиссионерПартнер));
	...
	definition.Вставить("ВариантКурсаДоговора", ксп_ЭкспортСлужебный.СоздатьУзелIdentification(Обк.ВариантКурсаДоговора));
	definition.Вставить("РазбиватьОтчетПоДокументам", ксп_ЭкспортСлужебный.СоздатьУзелIdentification(Обк.РазбиватьОтчетПоДокументам));
	definition.Вставить("ПорядокОтраженияНеотфактурованныхПоставокНУ", ксп_ЭкспортСлужебный.СоздатьУзелIdentification(Обк.ПорядокОтраженияНеотфактурованныхПоставокНУ));


	//------------------------------------------------------     ТЧ ДоговорыСЗаказчиком

	ТЧДоговорыСЗаказчиком = Новый Массив;

	Для сч = 0 По обк.ДоговорыСЗаказчиком.Количество()-1 Цикл

		стрк = обк.ДоговорыСЗаказчиком[сч];
		...
		ТЧДоговорыСЗаказчиком.Добавить(НовСтр);

	КонецЦикла;

	definition.Вставить("ТЧДоговорыСЗаказчиком", ТЧДоговорыСЗаказчиком);
