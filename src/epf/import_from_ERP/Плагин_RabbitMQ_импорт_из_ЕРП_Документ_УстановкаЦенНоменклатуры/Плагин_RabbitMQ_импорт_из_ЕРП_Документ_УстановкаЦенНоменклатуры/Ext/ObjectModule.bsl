...
Функция СоздатьОбновитьДокумент(СтруктураОбъекта) Экспорт
	...
	ДокументИзЕРП = "Установка Цен Номенклатуры (ЕРП) № " + деф.Number + " от " + строка(деф.Date);
	...
	Попытка			
		...
		РегистрыСведений.ксп_СоответствиеДокументовУстановкаЦен.ДобавитьЗапись(ОбъектДанных.Ссылка, деф.Number, id.ref);
