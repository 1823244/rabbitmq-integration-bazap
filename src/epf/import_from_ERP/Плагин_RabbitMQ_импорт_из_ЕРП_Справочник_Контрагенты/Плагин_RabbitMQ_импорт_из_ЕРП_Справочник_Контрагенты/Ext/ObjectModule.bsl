...
Функция ЗаполнитьРеквизитыЭлемента(ОбъектДанных, СтруктураОбъекта, jsonText = "") Экспорт
	...
	//	
	//IDКлиента	Строка	232203223473
	//KZ_БИН_ИИН	Строка	
	//KZ_Документ	Строка	
	//KZ_РНН	Строка	
	//АктуализацияДанных	ТабличнаяЧасть	АктуализацияДанных
	//Город	Города	Туапсе
	//ДатаГосРегистрации	Дата	26.01.2004 0:00:00
	//ДатаСоздания	Дата	19.06.2017 0:00:00
	//ИмяПредопределенныхДанных	Строка	
	//ИНН	Строка	232203223473
	//Код	Строка	ПЭС005495
	//КПП	Строка	
	//МенеджерСопровожденияКлиента	Физические лица	МАЛИНИНА ВАЛЕРИЯ НИКОЛАЕВНА
	//Наименование	Строка	ГЛАДКИХ Е.Г. ИП
	//НаименованиеПолное	Строка	Индивидуальный предприниматель ГЛАДКИХ Е.Г.
	//НеЯвляетсяРезидентом	Булево	Нет
	//НикНэйм	Строка	
	//ОГРН	Строка	304232202600062
	//Ответственный	Пользователь	Тер-Акопян И.В.
	//ОТП	Направление коммерческой деятельности	Юг
	//Покупатель	Булево	Да
	//ПометкаУдаления	Булево	Нет
	//ПослПорядковНомерОснАсс	Число	
	//ПослПорядковНомерПрочАсс	Число	
	//Предопределенный	Булево	Нет
	//Регион	Регионы	Краснодарский край
	//РедактировалсяВЛокальнойБазе	Булево	Нет
	//Родитель	Контрагенты	ОПТ
	//СозданВЛокальнойБазе	Булево	Нет
	//Ссылка	Контрагенты	ГЛАДКИХ Е.Г. ИП
	//Страна	Страна	РОССИЯ
	//Субрегион	Субрегионы ОТП	Юг
	//ФормаСобственности	Формы юридической собственности	ИП
	//ЭтоГруппа	Булево	Нет
	//ЮрФизЛицо	Юр физ лицо	Физ лицо	
