...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ПараметрыРегистрации.Вставить("Наименование","Плагин_RabbitMQ_импорт_из_ЕРП_Документ_ПланЗаказаКлиентовОпта");
	ПараметрыРегистрации.Вставить("БезопасныйРежим", Ложь);
	ПараметрыРегистрации.Вставить("Информация","Плагин_RabbitMQ_импорт_из_ЕРП_Документ_ПланЗаказаКлиентовОпта");
	...
	ДобавитьКоманду(ПараметрыРегистрации.Команды, 
		"Открыть форму : Плагин_RabbitMQ_импорт_из_ЕРП_Документ_ПланЗаказаКлиентовОпта",
		"Плагин_RabbitMQ_импорт_из_ЕРП_Документ_ПланЗаказаКлиентовОпта",
		ТипКоманды, 
		Ложь) ;
...
Функция ЗагрузитьОбъект(СтруктураОбъекта, jsonText = "") Экспорт
	...
	Если НЕ НРег(СтруктураОбъекта.type) = НРег("документ.планзаказаклиентовопта") Тогда
    ...
    ВидОбъекта = "ПланЗаказаКлиентовОпта";
...
Функция ЗаполнитьРеквизиты(ОбъектДанных, СтруктураОбъекта, jsonText = "") Экспорт
	...
	ОбъектДанных.Проект1 = ксп_ИмпортСлужебный.НайтиПроект(деф.Коллекция);
	...
	Для счПлан = 0 По деф.ТЧПлан.Количество()-1 Цикл
		стрк = деф.ТЧПлан[счПлан];
		НовСтр = ОбъектДанных.ПланыДляКонтрагентов.Добавить();    
		
		//Номенклатура Справочник Контрагенты
		НовСтр.Контрагент = ксп_ИмпортСлужебный.НайтиКонтрагента(стрк.Клиент);
		//СуммаЗаказаПоЦене1ДляПроекта1 Число
		НовСтр.СуммаЗаказаПоЦене1ДляПроекта1 = стрк.ПланПродаж;
		//СуммаЗаказаПоЦене1ФМДляПроекта1 Число
		НовСтр.СуммаЗаказаПоЦене1ФМДляПроекта1 = Стрк.ПланПродаж;
