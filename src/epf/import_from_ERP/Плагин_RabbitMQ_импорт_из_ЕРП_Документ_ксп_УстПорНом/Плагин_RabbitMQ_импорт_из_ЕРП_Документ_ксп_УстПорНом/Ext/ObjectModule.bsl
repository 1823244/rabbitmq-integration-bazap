...
Функция СоздатьОбновитьДокумент(СтруктураОбъекта) Экспорт
	...
	Попытка			
		...
		Исключение
		    ЗаписьЖурналаРегистрации(ИмяСобытияЖР, УровеньЖурналаРегистрации.Ошибка,,,"Не удалось записать документ "+ПредставлениеДокументаБазаП+". сообщение будет отправлено в retry-очередь");
			ВызватьИсключение;
		КонецПопытки;
