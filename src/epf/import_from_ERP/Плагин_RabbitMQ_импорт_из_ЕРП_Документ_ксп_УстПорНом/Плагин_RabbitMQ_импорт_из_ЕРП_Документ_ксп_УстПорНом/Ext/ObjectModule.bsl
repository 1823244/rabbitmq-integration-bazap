...
Функция СоздатьОбновитьДокумент(СтруктураОбъекта) Экспорт
	...
	Попытка			
		...
		Исключение
		    ЗаписьЖурналаРегистрации(ИмяСобытияЖР, УровеньЖурналаРегистрации.Ошибка,,,"Не удалось провести документ "+ПредставлениеДокументаБазаП+". Будет выполнена запись без проведения");
			//ВызватьИсключение;
		КонецПопытки;
